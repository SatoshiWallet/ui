...
const strings = {
  ...
  edge_description:
    'This application would like to create or access its wallet in your SatoshiWallet account.\n\n It will not have access to any other wallets.',
  ...
  fragment_wallets_seed_share_title: 'SatoshiWallet (%s) Seed',
  ...
  request_review_android_page_link: 'https://play.google.com/store/apps/details?id=co.satoshiwallet.app&hl=en_US',
  request_share_edge_request: 'Share Wallet Request',
  ...
  send_scan_header_text: 'Scan to Send, Sweep, or Login',
  send_scan_edge_login_success_title: 'Wallet Login Successful',
  send_scan_edge_login_success_message: 'To continue, please return to the browser or application that requested the Wallet Login.',
  send_to_title: 'To: %s',
  ...
  ss_need_more_kyc:
    'You have an active ShapeShift account linked to this Wallet account. However, it still requires verification before ShapeShift can process this exchange request. Please proceed to ShapeShift.io, login with your ShapeShift account credentials, and complete your verification.',
  ...
  edge_login_fetching: 'Fetching Wallet Login info...',
  ...
  plugin_provider_disclaimer: 'The following services are not provided by Wallet. \n\nFor issues and feedback please contact the respective service providers.',
